...
int main(int argc, char* argv[]) {
    ...
    while (loop) {
        ...
        case 1:
            tester.runTests(inputPaths, outputPaths, kernelIdentity);
            break;

        case 2:
            tester.runTests(inputPaths, outputPaths, kernelGaussianBlur);
            break;

        case 3:
            tester.runTests(inputPaths, outputPaths, kernelEdgeDetection);
            break;

        case 4:
            tester.runTests(inputPaths, outputPaths, kernelBoxBlur);
            break;

        case 5:
            tester.runTests(inputPaths, outputPaths, kernelSharpen);
            break;
